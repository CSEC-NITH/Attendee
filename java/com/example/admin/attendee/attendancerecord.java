...
public class attendancerecord extends AppCompatActivity
{
    ...
    String []arr1={" ","EVS","DS","SS","CC","DSlab"};
    int []start1={0,30,80,130,210,370};
    int []span1={0,50,50,50,50,210};

    String []arr2={" ","EVS","DS","SS","CC","DSlab"};
    int []start2={0,30,90,240,400};
    int []span2={0,90,150,320,480};

    String []arr3={" ","EVS","DS","SS","CC","DSlab"};
    int []start3={0,30,80,130,210,370};
    int []span3={0,50,50,50,50,210};

    String []arr4={" ","EVS","DS","SS","CC","DSlab"};
    int []start4={0,30,90,240,400};
    int []span4={0,90,150,320,480};

    String []arr5={" ","EVS","DS","SS","CC","DSlab"};
